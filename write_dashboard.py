content = r"""const { useState, useEffect, useRef } = React;
...
with open(r'c:\Users\hp\.m2\HydroSense\dashboard\static\app.jsx', 'w', encoding='utf-8') as f:
    f.write(content)

print('app.jsx written successfully. Lines:', len(content.splitlines()))
